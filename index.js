...
app.get('/home/:id', (request, response) => {
  ...
  const person  = people[request.params.id];
...
// console.log( 'loaded products' );
// console.log( products.items[request.params.id].product.title );
// //
//   const items = products.items;
//   console.log(items[0].name);
  // running this will let express to run home.handlebars file in your views folder

  // var item = products.items[request.params.id];
  const data = {
    itemsKey : products.items
  };
...
//   console.log(items[0].name);
  ...
  const data = {
    thisItem : products.items[request.params.id]
  };
